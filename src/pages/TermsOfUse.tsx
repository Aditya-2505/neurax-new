        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-4 gap-8 relative z-10">
          ...
          <div className="lg:col-span-3">
            <div className="glass-panel rounded-2xl p-8 md:p-10">
              ...
              <div className="bg-blue-950/20 rounded-lg p-4 border border-blue-900/30 mb-6 flex items-start gap-3">
              ...
              <div className="space-y-4 text-gray-350 text-sm leading-relaxed">
                <div>
                  <h3 className="text-white font-bold mb-1">7. Indemnification</h3>
                ...
                <div>
                  <h3 className="text-white font-bold mb-1">8. Termination</h3>
                ...
                <div>
                  <h3 className="text-white font-bold mb-1">10. Changes to Terms</h3>
                  <p>We may update these Terms from time to time. Continued use of the platform constitutes acceptance of any changes.</p>
                </div>
                <div>
                  <h3 className="text-white font-bold mb-1">11. Contact Us</h3>
                  <p>For questions about these Terms, contact us at: <span className="text-blue-400">hello@neuraxcog.com</span></p>
                </div>
              </div>
            </div>
          </div>
